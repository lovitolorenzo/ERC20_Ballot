...
export declare namespace TokenizedBallot {
...
export interface TokenizedBallot extends BaseContract {
  ...
  functions: {
    ...
    winningProposal(
      ...
      [TokenizedBallot.ProposalStructOutput] & {
        winningProposal_: TokenizedBallot.ProposalStructOutput;
      }
    >;
  };
  ...
  winningProposal(
    overrides?: CallOverrides
  ): Promise<TokenizedBallot.ProposalStructOutput>;
